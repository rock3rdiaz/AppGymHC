...
class Lesion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipo', 'required'),
			array('tipo, descripcion', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idLesion, tipo, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'antecedentesTraumaLesions' => array(self::MANY_MANY, 'AntecedentesTraumaLesion', 'Antecedentes_trauma_lesion_lesion(idLesion, idAntecedentes_trauma_lesion)'),
		);
	}
